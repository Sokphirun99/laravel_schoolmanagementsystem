                                    ...
                                    <tr>
                                        @if($showCheckboxColumn)
                                            <th class="dt-not-orderable">
                                                <input type="checkbox" class="select_all" id="select_all" name="select_all">
                                            </th>
                                        @endif
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <form action="#" id="delete_form" method="POST">
                        {{ method_field('DELETE') }}
                        {{ csrf_field() }}
                        <input type="submit" class="btn btn-danger pull-right delete-confirm" id="confirm_delete_btn" name="confirm_delete" value="{{ __('voyager::generic.delete_confirm') }}">
                    </form>
