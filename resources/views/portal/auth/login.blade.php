...
<head>
    ...
    <style>
        body {
            background-image: url('{{ asset('voyager-assets/images/bg.jpg') }}');
            ...
            <div class="clearfix">
                <div class="col-sm-12 col-md-10 col-md-offset-2">
                    <div class="logo-title-container">
                        <img class="img-responsive pull-left flip logo hidden-xs animated fadeIn" src="{{ asset('images/school-logo.png') }}" alt="School Logo">
                        <div class="copy animated fadeIn">
                            <h1>Student & Parent Portal</h1>
                            <p>Welcome to the School Management System Portal</p>
                        </div>
